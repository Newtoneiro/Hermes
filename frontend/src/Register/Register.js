  ...
  return <>
    {RegisterCon.redirectOnRegister && <Redirect to='/login'/>}
        ...
        <form className='Form_main-form'>
           <div className={`Form_main-input_box ${RegisterCon.inputs[0] && 'Form_main-input_box-incorrect'}`}>
            ...
            <div className={`Form_main-input_box ${RegisterCon.inputs[1] && 'Form_main-input_box-incorrect'}`}>
            ...
            <div className={`Form_main-input_box ${RegisterCon.inputs[2] && 'Form_main-input_box-incorrect'}`}>
            ...
            <div className={`Form_main-input_box ${RegisterCon.inputs[3] && 'Form_main-input_box-incorrect'}`}>
